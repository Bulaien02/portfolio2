        ...
        <section className="text-white grid" id="aboutMe">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:px-32 py-16 xl-gap-16 items-center">
                ...
                <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
                    ...
                    <p className="text-base text-justify lg:text-lg">I have attended Asia Pacific University of Technology and Innovation (APU) to further my degree education. I've been specializing in data analytics while studying computer science. My prior coursework consisted of SPM, STPM, and ultimately an APU degree.  </p>
